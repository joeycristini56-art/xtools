...
**MANDATORY**:
- ✅ **FULL INTEGRATION ONLY**: No stubs, no demos, no placeholder code, no "would run here" comments
- ✅ **COMPLETE CODE**: Every function must be fully implemented with real logic
- ✅ **SIMPLIFIED CODE**: Clean, production-ready code without unnecessary complexity
- ✅ **NO DEMOS**: Nothing that says "for now" or "placeholder"
- ✅ **NO STOPPING**: Work continuously until everything is fully deployed and functional
- ✅ **24/7 CODING**: I am deployed for coding only, not tracking timelines or project management
- ✅ **FINISH EVERYTHING**: Don't stop working till every single tool works perfectly on all platforms

**DEVELOPMENT APPROACH**:
- Work on one platform at a time until it's 100% functional
- Test each tool thoroughly - if it doesn't work, fix it
- No cutting corners - full implementation of every feature
- If code is needed, write complete working code
- Deploy and verify on real devices before moving on

**SUCCESS CRITERIA**:
- ✅ All tools accessible through UI on all platforms
- ✅ FFI libraries compiled and working for all platforms
- ✅ NO stubs or placeholder code anywhere in the codebase
- ✅ Every Python function has real implementation
- ✅ Every Go function has real implementation
- ✅ Graceful error handling for all failure cases
- ✅ User-friendly setup and onboarding
