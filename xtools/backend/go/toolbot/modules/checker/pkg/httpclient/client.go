...
// GetFreshClient creates and returns a new HTTP client without using the pool
// This ensures no cookie/session contamination between account checks
func GetFreshClient() *requests.Client {
